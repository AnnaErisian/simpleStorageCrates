...
public class TileEntityInventoryBasic extends TileEntity implements IInventory {
    ...
    public NBTTagCompound writeToNBT(NBTTagCompound parentNBTTagCompound)
    {
        ...
        for (int i = 0; i < this.itemStacks.length; ++i) {
            if (!this.itemStacks[i].isEmpty())	{ //isEmpty()
                ...
                dataForThisSlot.setShort("Slot", (short) i);
    ...
    public void readFromNBT(NBTTagCompound parentNBTTagCompound)
    {
        ...
        for (int i = 0; i < dataForAllSlots.tagCount(); ++i) {
            ...
            int slotIndex = dataForOneSlot.getShort("Slot");
    ...
    public String getName() {
        return "container.storagecrates:mbe30_inventory_basic.name";
    }
    ...
    public void onTabChange(int buttonID, EntityPlayer player) {
        if (player != null && this.pos != null) {
            player.openGui(StorageCrates.instance, GuiHandlerMBE30.getGuiID()+buttonID, this.world, this.pos.getX(), this.pos.getY(), this.pos.getZ());
        }
    }
