package blue.thejester.storagecrates.block;
...
public class BlockInventoryBasic extends BlockContainer {
    ...
    public TileEntity createNewTileEntity(World worldIn, int meta) {
        switch (this.type) {
            ...
            case 2:
                return new TileEntityInventoryBasicMed();
            default:
                return new TileEntityInventoryBasicLarge();
        }
    }
    ...
    public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumHand hand,
        ...
        playerIn.openGui(StorageCrates.instance, GuiHandlerMBE30.getGuiID()+1, worldIn, pos.getX(), pos.getY(), pos.getZ());
        return true;
    }
    ...
    public AxisAlignedBB getBoundingBox(IBlockState state, IBlockAccess source, BlockPos pos) {
        return new AxisAlignedBB(1 / 16.0F, 1 / 16.0F, 1 / 16.0F, 15 / 16.0F, 15 / 16.0F, 15 / 16.0F);
    }
